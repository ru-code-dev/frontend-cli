/**
 * `@smart-tools/fg-pixso` — the pixso feature package, and the engine boundary.
 *
 ...
 * by hand. A test that spelled `fg-out/pixso/11-10.svg` itself would pass while the product
