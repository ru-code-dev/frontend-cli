...
export const missingAccessibleNameRule: Rule = {
  ...
  label: { ru: "Контрол без доступного имени", en: "Control with no accessible name" },
  ...
  subkindLabels: {
    iconOnly: { ru: "только иконка, без имени", en: "icon only, no name" },
    unlabelled: {
      ru: "имя должно приходить из aria-labelledby",
      en: "the name has to come from aria-labelledby",
    },
    empty: { ru: "ни текста, ни метки", en: "no text and no label" },
  },
  severity: "error",
