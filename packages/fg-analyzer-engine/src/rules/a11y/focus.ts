...
export const suppressedFocusRule: Rule = {
  ...
  label: { ru: "Кольцо фокуса убрано без замены", en: "Focus ring removed with no replacement" },
  ...
  subkindLabels: {
    blanket: { ru: "сброс без замены", en: "reset with no replacement" },
    onFocus: { ru: "убрано прямо на :focus", en: "removed on :focus itself" },
  },
  severity: "error",
