...
export const ariaRelationsRule: Rule = {
  ...
  label: { ru: "ARIA-связь ведёт в никуда", en: "ARIA relation pointing nowhere" },
  ...
  subkindLabels: {
    danglingId: { ru: "ссылка на несуществующий id", en: "reference to an id that is not there" },
    unmatchedExpression: { ru: "выражения не совпали", en: "the expressions did not match" },
  },
  severity: "mixed",
