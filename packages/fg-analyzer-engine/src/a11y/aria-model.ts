 ...
 */
export const roleNames = (): readonly string[] => [...CONCRETE_ROLES].toSorted();

export const ariaAttributeNames = (): readonly string[] => [...ALL_ARIA_ATTRIBUTES].toSorted();
...
export const prohibitedPropsOf = (role: string): readonly string[] =>
  [...(roleTable.get(role)?.prohibitedProps ?? [])].toSorted();
