/**
 * `@smart-tools/fg-source` — the SHARED ACQUISITION package: one function that turns whatever
 ...
 *   `dist/fg.mjs` (design h4:56-64 is a bundle-size budget; this side of it stays at zero).
 *
